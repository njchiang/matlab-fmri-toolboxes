...
userOptions = defineUserOptions_SVM();
...
fullBrainVols=fMRIDataPreparation(betaCorrespondence_SVM(), userOptions);
...
for m =1:length(userOptions.maskNames)
    ...
    singleSubjectPattern=zscore(thesePatterns); % make sure this is right
